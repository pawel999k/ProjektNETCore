...
namespace NETCore.Controllers
{
    public class KlientsController : Controller
    {
        ...
        public KlientsController(DBContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Imie,Nazwisko,Adres,Email")] Klient klient)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Imie,Nazwisko,Adres,Email")] Klient klient)
        {
            if (id != klient.Id)
            {
                return NotFound();
